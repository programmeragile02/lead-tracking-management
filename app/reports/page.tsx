...
export default function ReportsPage() {
  return (
    <DashboardLayout title="Laporan" role="manager">
      <div className="space-y-6">
        ...
        <section className="bg-white rounded-2xl p-6 shadow-md border-2 border-gray-100">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Tren Lead Bulanan</h3>
          <LeadsReportChart />
        </section>

        {/* Revenue Trends */}
        <section className="bg-white rounded-2xl p-6 shadow-md border-2 border-gray-100">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Tren Pendapatan Bulanan</h3>
          <RevenueReportChart />
        </section>

        {/* Conversion Funnel */}
        <section className="bg-white rounded-2xl p-6 shadow-md border-2 border-gray-100">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Funnel Konversi</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Channel Comparison */}
          <section className="bg-white rounded-2xl p-6 shadow-md border-2 border-gray-100">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Perbandingan Channel</h3>
