...
//   // produk (ambil produk tersedia, ambil page pertama saja)
...
//         // optional: salesId kalau mau kirim manual
//         // salesId: ...
//       };
...
//             Isi informasi dasar lead, pilih produk, dan field tambahan. Tahap
//             &amp; status awal akan otomatis diatur (Kontak awal &amp; Warm).
//           </p>
//         </div>

//         <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-4 md:p-6 space-y-6">
//           {/* === FIELD PATEN === */}
//           {/* Nama & HP */}
...
//               Produk ini akan tercatat sebagai produk utama untuk lead ini.
//             </p>
//           </div>
...
//               rows={3}
//               placeholder="Alamat lengkap lead (opsional)..."
//             />
//           </div>

//           {/* Foto Lead */}
//           <div className="space-y-2">
//             <Label>Foto Lead (opsional)</Label>
...
//               <p className="font-medium text-gray-700">Tahap Awal</p>
//               <p className="text-gray-600">
//                 <span className="font-semibold">Kontak Awal</span>{" "}
//                 <span className="text-xs text-gray-500">
//                   (ditetapkan otomatis oleh sistem)
//                 </span>
//               </p>
//             </div>
//             <div className="space-y-1 text-sm">
//               <p className="font-medium text-gray-700">Status Awal</p>
//               <p className="text-gray-600">
...
//                 Informasi Tambahan (Field Dinamis)
//               </h3>
//               {loadingFields && (
//                 <span className="text-xs text-gray-500">
