    ...
    <div className="gradient-primary rounded-2xl p-6 shadow-lg">
      <div className="flex flex-col sm:flex-row items-center gap-6">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          <p className="text-white/90 font-medium mb-2">Sales Representative</p>
          <p className="text-white/80 text-sm">andi@company.com</p>
        </div>

        <Button variant="secondary" className="bg-white text-red-600 hover:bg-gray-100 font-semibold shadow-md">
          Edit Profil
        </Button>
      </div>
    </div>
